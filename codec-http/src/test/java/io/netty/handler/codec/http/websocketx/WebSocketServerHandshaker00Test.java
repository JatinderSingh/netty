...
public class WebSocketServerHandshaker00Test {
    ...
    private static void testPerformOpeningHandshake0(boolean subProtocol) {
        ...
        FullHttpRequest req = ReferenceCountUtil.releaseLater(new DefaultFullHttpRequest(HTTP_1_1, HttpMethod.GET,
                new AppendableCharSequence("/chat"), Unpooled.copiedBuffer("^n:ds[4U", CharsetUtil.US_ASCII)));
