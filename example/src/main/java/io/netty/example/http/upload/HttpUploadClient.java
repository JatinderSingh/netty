...
public final class HttpUploadClient {
    ...
    private static List<Entry<String, String>> formget(
        ...
        HttpRequest request = new DefaultHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.GET, new AppendableCharSequence(uriGet.toASCIIString()));
    ...
    private static void formpostmultipart(
        ...
        // Prepare the HTTP request.
        HttpRequest request =
                new DefaultHttpRequest(HttpVersion.HTTP_1_1, HttpMethod.POST, new AppendableCharSequence(uriFile.toASCIIString()));
